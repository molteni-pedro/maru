...
if ( ! class_exists( 'Jet_Engine_Elementor_Pro_Package' ) ) {
	...
	class Jet_Engine_Elementor_Pro_Package {
		...
		public function __construct() {
			...
			add_action( 'elementor/theme/before_do_popup', array( $this, 'set_force_dynamic_print_css' ) );
			add_action( 'elementor/theme/after_do_popup',  array( $this, 'restore_force_dynamic_print_css' ) );
		...
		public function set_force_dynamic_print_css() {

			if ( ! jet_engine()->dynamic_tags ) {
				return;
			}

			if ( ! method_exists( jet_engine()->dynamic_tags, 'force_print_css' ) ) {
				return;
			}

			jet_engine()->dynamic_tags->force_print_css( true );
		}

		public function restore_force_dynamic_print_css() {
			...
			jet_engine()->dynamic_tags->force_print_css( false );
		}
